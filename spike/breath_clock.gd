...
##
## We also expose `real_seconds` (wall clock, OS.get_ticks_usec based) alongside
...
var _last_phase: int = BreathModel.Phase.INHALE
...
func _process(delta: float) -> void:
	...
	var phase: int = BreathModel.phase_at(cycle_time)
